...
+ (void)moveUp:(UIView *)view andAnimationDuration:(float) timeDuration viewCenter:(CGPoint *)center duration:(float) Duration{
    [UIView animateWithDuration:timeDuration delay:0 options:UIViewAnimationOptionCurveEaseIn animations:^{
        //确定UIView的的中心位置和偏转角度
        view.center = CGPointMake(80.0f, 108.0f);
        view.transform = CGAffineTransformMakeRotation(-0.22f);
